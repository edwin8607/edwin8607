...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { descripcion: @proyecto.descripcion, fechafinalizacion: @proyecto.fechafinalizacion, fechainico: @proyecto.fechainico, nombre: @proyecto.nombre }
    end
  ...
  test "should update proyecto" do
    patch :update, id: @proyecto, proyecto: { descripcion: @proyecto.descripcion, fechafinalizacion: @proyecto.fechafinalizacion, fechainico: @proyecto.fechainico, nombre: @proyecto.nombre }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
